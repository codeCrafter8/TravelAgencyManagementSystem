...
public class Validation{
     ...
     */
    public static boolean countryOrCityIsValid(String text){
     ...
     */
    public static boolean hotelNameIsValid(String hotelName){
     ...
     */
    public static boolean peopleLimitIsValid(String peopleLimit){
     ...
     */
    public static boolean firstNameAndLastNameIsValid(String firstNameAndLastName){
     ...
     */
    public static boolean creditCardNumberIsValid(String creditCardNumber){
