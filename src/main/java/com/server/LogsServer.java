...
/**
 * Class containing fields and methods operating on events generated by the server.
 */
public class LogsServer extends Logs {
    /**
     * Attribute representing a list that stores events generated by the server.
     */
