...
/**
 * Klasa zawierająca pola i metody operujące na zdarzeniach pochodzących od działań administratorów
 */
public class LogsAdmins extends Logs{
    /**
     * Atrybut bedący listą przechowującą zdarzenia pochodzące od działań administratorów
     */
