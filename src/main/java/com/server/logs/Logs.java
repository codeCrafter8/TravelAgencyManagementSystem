...
/**
 * A class containing fields and methods for logging events generated by the application to a file.
 */
public class Logs {

    /**
     * An attribute used to set the appropriate type of event log.
     */
    private final Logger log;

    /**
     * An attribute specifying the event message.
     */
    private static String message;

    /**
     * An attribute specifying the name of the class from which events are currently being retrieved.
     */
    private static String className;

    /**
     * A constructor allowing the initialization of final fields and calling the method responsible for writing the event to a file.
     *
