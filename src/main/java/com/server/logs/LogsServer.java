...
/**
 * A class containing fields and methods operating on events generated by the server.
 */
public class LogsServer extends Logs {

    /**
     * An attribute representing a list that stores events generated by the server.
     */
