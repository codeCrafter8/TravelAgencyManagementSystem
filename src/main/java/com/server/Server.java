...
import com.server.logs.gui.AdminsLogs;
import com.server.logs.gui.ClientsLogs;
import com.server.logs.gui.ServerLogs;
    ...
    private void operate() {
        try {
            ...
            while (running) {
                ...
                SwingWorker<Void, Void> worker = new BackgroundHandler(socket, threads);
                worker.execute();
            }
